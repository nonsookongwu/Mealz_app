...
class Categories extends StatelessWidget {
  const Categories({super.key, required this.onSelectmeal});

  final void Function(Meal meal) onSelectmeal;

  void _handleNavigateMeals(BuildContext context, Category category) {
    final availableMeal = dummyMeals
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (ctx) =>
            MealsWidget(meals: availableMeal, title: category.title, onSelectmeal: onSelectmeal,),
      ),
    );
  }
